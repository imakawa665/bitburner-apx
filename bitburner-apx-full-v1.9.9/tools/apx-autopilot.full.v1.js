...
function apxFmtRam(ns, gb){
  ...
  const F=ns.flags([
    ['interval',1000],['hud',false],['noDom',true],
    ...
    ['repMode',false],['shareReserveHomeGB',8],
  ...
  ns.tprint(`[autopilot] reserve=${apxFmtMoney(ns,reserve())}`);
  ...
  runOnce('tools/apx-spread.remote.v1.js');
