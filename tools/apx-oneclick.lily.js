...
export async function main(ns){
  ...
  if (pf==='rep'){ setMark(true); ns.run('tools/apx-autopilot.full.v1.js',1,'--interval',1000,'--repMode','true','--uiLock','/Temp/apx.ui.lock.txt'); ns.tprint(`[oneclick] 起動: REPモード (autopilot v1.9.3)`); return; }
  if (pf==='autofull'){ setMark(false); ns.run('tools/apx-autopilot.full.v1.js',1,'--interval',1100,'--uiLock','/Temp/apx.ui.lock.txt'); ns.tprint(`[oneclick] 起動: AUTOFULL (autopilot v1.9.3)`); return; }
