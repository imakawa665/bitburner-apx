/** tools/apx-oneclick.lily.js (v1.3.1) */
export async function main(ns) {
  ...
  ns.tprint(`[oneclick] 起動完了: HUD=${F.hud} rooter=${F.rooter} micro=${F.micro} pserv=${F.pserv} hacknet=${F.hacknet} share=${F.share} spread=${F.spread} batcher=${F.withBatcher} backdoor=${F.backdoor} daemon=${F.daemon}`);
}
